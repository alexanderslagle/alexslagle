...
export class ProjectsService {
  projects: Project[] = [
    ...
    {id: 2, name: "Monster Cleaning", description: "First person shooter", platforms: "Apple App Store and Google Play.", role: "Game Programmer.", imagePath: "../../assets/Monster Cleaning.png", routerLink: "/portfolio/monster-cleaning",
     summary: " I worked with OVIVO Games, I was pitched a few game designs and selected one. I implemented the game based on a game design document. I worked with the Project Manager, Artist, and CEO to bring the game to life.", youtubeLink: "https://www.youtube.com/embed/nqJeoB2njps", appleAppStoreLink: "https://apps.apple.com/us/app/monster-cleaning/id1543320589", googlePlayLink: "https://play.google.com/store/apps/details?id=com.slaglegames.monster", releasedOnAppStores: true, youtubeHeight: 560, youtubeWidth: 315},
    ...
    {id: 6, name: "House Cat", description: "Endless runner", platforms: "Apple App Store and Google Play, but I removed this game from the app stores.", role: "Game Designer and Game Programmer.", imagePath: "../../assets/House Cat.png", routerLink: "/portfolio/house-cat", summary: "This was the first game I ever made. The player taps either the left or right half of the screen to move the cat.",
