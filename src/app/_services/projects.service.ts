...
export class ProjectsService {
  projects: Project[] = [
    ...
    toolsUsed: "Unity, C#, Azure DevOps, and Git.", imagePath: "../../assets/Monster Cleaning.png", routerLink: "/portfolio/monster-cleaning", 
     summary: " Monster Cleaning is a first person shooter where the player moves in all directions, shooting and taking cover from rushing monsters. Alex worked with OVIVO Games, Alex was pitched a few game designs and selected one. Alex implemented the game based on a game design document. Alex worked with the Project Manager, Artist, and CEO to bring the game to life.", youtubeLink: "https://www.youtube.com/embed/nqJeoB2njps", appleAppStoreLink: "https://apps.apple.com/us/app/monster-cleaning/id1543320589", googlePlayLink: "https://play.google.com/store/apps/details?id=com.slaglegames.monster", releasedOnAppStores: true, youtubeHeight: 560, youtubeWidth: 315},
    ...
    toolsUsed: "Unity, C#, Azure DevOps, Git, and Draw.IO.", role: "Game Designer and Game Programmer.",  routerLink: "/portfolio/battle-ship",
     summary: "Battle Ship was a two-week coding assignment where Alex was assigned to implement a single-player version of the board game Battleship against any kind of AI or random moves.", youtubeLink: "https://www.youtube.com/embed/EfPdKr0YzeQ?si=qxUWXKyCAIkO7V72", appleAppStoreLink: "", googlePlayLink: "", releasedOnAppStores: false, youtubeHeight: 315, youtubeWidth: 560},
  ];
  constructor() { }
